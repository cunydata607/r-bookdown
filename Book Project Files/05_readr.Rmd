...
`read_csv()` uses the first line of the data for the column names, the following examples will show how to tweak this behavior:
    ...
    <u>Using skip = n (n is the number of lines to skip)</u>
...
```
    ...
    <u>Using comment = "#" to skip all lines that starts with "#"</u>
...
```
    ...
    <u>If there's no column names, using col_names = FALSE</u>
